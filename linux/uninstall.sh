...
rm -f "$HOME/.local/share/applications/lr-swaper-iconname.desktop"
rm -f "$HOME/.local/share/applications/bt-lr-swapper.desktop"
rm -f "$HOME/.local/share/applications/com.tihulu.lr-swaper.desktop"
rm -f "$HOME/.local/share/pixmaps/lr-swaper.png"
